...
"""
LW DETR Projector
copied from: https://github.com/Atten4Vis/LW-DETR/blob/main/models/backbone/projector.py
"""
import torch
...
class MultiScaleProjector(BaseModule):
    """
    ...
    def __init__(
        ...
        Args:
            ...
            num_blocks (int): Number of blocks in C2f module
        """
    ...
    def forward(self, x):
        """
        Args:
            x: List of tensors of shape (N,C,H,W). H, W must be a multiple of ``self.size_divisibility``.
        Returns:
            list[tensor]:
